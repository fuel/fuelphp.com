...
Cufon.replace('#calltos #download .link', { textShadow: '0px 3px 0px #c02fcf' });
Cufon.replace('#calltos #discover .link', { textShadow: '0px 3px 0px #9e31d6' });
Cufon.replace('#calltos #contribute .link', { textShadow: '0px 3px 0px #7431d6' });
