<section class="title">
	<h4><?php echo lang('forums_forum_label') . ' ' . lang('forums_list_categories_title');?></h4>
</section>
<section class="item">
			...
			<?php foreach ($categories as $cat): ?>
				<tr>
					...
					<td class="buttons buttons-small">
						<?php echo anchor("admin/forums/list_forums/{$cat->id}", lang('forums_list_forum_title'), array('class' => 'btn green')); ?>
						<?php echo anchor('admin/forums/edit_category/' . $cat->id, lang('forums_edit_label'), array('class'=>'btn orange'));?> 
						<?php echo anchor('admin/forums/delete/category/' . $cat->id, lang('forums_delete_label'), array('class'=>'btn red confirm')); ?>
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
