...
$config['bbcodes'] = array(
	...
	"url"   => "javascript:insert_code('[url]', '[/url]', true);return(false)",
...
$config['bbcodes_to_parse'] = array(
	...
	"#\[quote author=(.+) date=(.+)\](.+)\[/quote\]#isU"    => array("<blockquote cite=\"$1\"><p><strong>$1 - $2</strong></p><p>$3</p></blockquote>", "\"$2\" ($1)", 5),
	"#\[code\](.+)\[/code\]#isU"			=> array("<code>$1</code>", "", 1),
);
/* End of file config/bbcode.php */